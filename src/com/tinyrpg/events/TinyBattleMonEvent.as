package com.tinyrpg.events 
{
	 ...
	 * @author jeremyabel
	 */
	public class TinyBattleMonEvent extends Event 
	{
		...
		public function TinyBattleMonEvent(type : String, move : TinyMoveData = null, mon : TinyMon = null, item : TinyItem = null)
		{
			this.move = move;
			this.item = item;
			this.mon = mon;
