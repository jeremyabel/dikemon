package com.tinyrpg.data 
{
	...
	/**
	 * Class which handles data for a single mon's battle stats.
	 *  
	 * @author jeremyabel
	 */
	public class TinyStatSet 
	{
		 ...
		 * @param	spAttack	Special Attack
		 * @param	spDefense	Special Defense
		 * @param	speed		Speed
		 * @param	canModify	
		 */
		...
		/**
		 * Prints out infomation about the stat set. 
		 */
		...
		/**
		 * Serializes the stat set to a JSON object.
		...
		/**
		 * Returns a new stat set generated by the given JSON object.
		 * Used when recreating a mon's stats from game save data.
		 */
		...
		/**
		 * Returns the stat multiplier at a given modifier stage.
		 * 
		 * During battle, some moves can modify a mon's stat values. 
		 * These modifications are done using "stat stages", which are 
		 * multipliers that are applied to the affected stat. 
		 */
